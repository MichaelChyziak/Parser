...
//		delete prev;
	...
	//overriden = operator;
	void operator =(const Token& right_side) {
		//TO DO
	}
...
public:
	...
	//Copy Constructer
	TokenList(const TokenList& old_list) {
		//TO DO
	}
...
//		delete tail;
	...
	//overriden = operator;
	void operator =(const TokenList& right_side) {
		//TO DO
	}
...
public:
	...
	//Copy Constructor
	Tokenizer(const Tokenizer& old_tokenizer) {
		//TO DO
	}
...
//		delete str;
	...
	//overriden = operator;
	void operator =(const Tokenizer& right_side) {
		//TO DO
	}
